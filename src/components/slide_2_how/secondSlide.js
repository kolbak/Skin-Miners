        ...
        <div className="carousel-inner">
          ...
          <div key={4} className="carousel-item" id="fourth-slide-pos">
            <div className="row">
              ...
              <video className="slide-video" poster={miningPoster} width="500" height="400" preload="true" playsInline loop muted onError={alert}>
                <source src={miningVideo} type='video/mp4' onError={alert} />
